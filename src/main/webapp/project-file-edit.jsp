...
<form name="form2" enctype="multipart/form-data" id="form2" action="${pageContext.request.contextPath}/attachment/update" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="attname" value="${attachment.attname}"/>
	</td>
</tr>
<tr >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		${attachment.path}
		<input name="attachFile" type="file"/>&nbsp;&nbsp;&nbsp;<a>添加</a>&nbsp;&nbsp;&nbsp;<a>删除</a>
</tr >
