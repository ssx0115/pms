...
<!--  搜索表单  -->
<form id="form3" name='form3' action='${pageContext.request.contextPath}/customer/search' method='get'>
...
<c:forEach items="${customers}" var="customer" varStatus="index">
    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        ...
        <td><a href="${pageContext.request.contextPath}/customer/edit/${customer.id}">编辑</a>
            | <a href="${pageContext.request.contextPath}/customer/selectCustomerById/${customer.id}">查看详情</a></td>
    </tr>
</c:forEach>
...
<script type="text/javascript">
    ...
    function batchDelete() {
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/customer/batchDelete",
