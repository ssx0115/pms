...
<body target="main">
	<table  width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' >
        <tr><td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
			...
			<c:forEach items="${sessionScope.sourcesList}" varStatus="ss">
...
<li><a href='${pageContext.request.contextPath}/project/list' target='main'>基本信息管理</a> </li>
<li><a href='${pageContext.request.contextPath}/analysis/list' target='main'>需求分析管理</a> </li>
<li><a href='${pageContext.request.contextPath}/model/list' target='main'>模块管理</a> </li>
<li><a href='${pageContext.request.contextPath}/function/list' target='main'>功能管理</a> </li>
<li><a href='${pageContext.request.contextPath}/attachment/list' target='main'>附件管理</a> </li>
</ul>
</dd>
</dl>
...
<dl class='bitem'><dt onclick=showHide('items2_1')><b>日常办公</b></dt><dd style='display:none' class='sitem' id=items2_1><ul class='sitemu' id=1>
	...
	<li><a href='${pageContext.request.contextPath}/notice/list' target='main'>通知公告</a></li>
	...
	<li><a href='${pageContext.request.contextPath}/baoxiao/listuuu' target='main'>我的报销</a> </li>
	<li><a href='fatie.jsp' target='main'>发帖</a> </li>
</ul></dd></dl>
...
<dl class='bitem'><dt onclick=showHide("items3_1")><b>信息箱</b></dt><dd style='display:none' class='sitem' id=items3_1><ul class='sitemu' id=2>
	...
	<li><a href='${pageContext.request.contextPath}/email/selectSendMessageByEmpfk' target='main'>发件箱</a> </li>
