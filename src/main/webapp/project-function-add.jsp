...
<form name="form2" id="form2" action="function/insert" method="POST">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="proname" id="proname" onchange="getAnalysis(this.value)">
			<option>--请选择--</option>
		</select>
	</td>
</tr>
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="analysisname" name="analysisname" onchange="getModel(this.value)">
			<option>--请选择--</option>
		</select>
	</td>
</tr>
