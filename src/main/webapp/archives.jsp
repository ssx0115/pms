...
<c:forEach items="${archivesList}" var="archives" varStatus="index">
	<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
		<td><input name="id" type="checkbox" id="id" value="${archives.dnum}" class="np"></td>
		<td>${index.count}</td>
		<td align="center"><a href=''><u>${archives.ename}</u></a></td>
		<td>${archives.eage}</td>
		<td>${archives.school}</td>
		<td>
			<fmt:formatDate value="${archives.hirdate}" pattern="yyyy-MM-dd"/>
		</td>
