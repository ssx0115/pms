...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/baoxiao/saveInfo" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input size="52" id="bxtime" name="bxtime"/>
		<img onclick="WdatePicker({el:'bxtime','minDate':'%y-%M-%d'})" src="${pageContext.request.contextPath}/static/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
