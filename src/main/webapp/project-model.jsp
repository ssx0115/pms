...
<c:forEach items="${models}" var="model" varStatus="index">
    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        <td><input name="id" type="checkbox" id="id" value="${model.id}" class="np"></td>
        <td>${index.count}</td>
        <td align="center"><a href=''><u>${model.modname}</u></a></td>
        <td align="center"><a href=''><u>${model.analysis.title}</u></a></td>
        <td align="center"><a href=''><u>${model.project.pname}</u></a></td>
        <td>${model.level}</td>
        <td><a href="project-model-edit.jsp">编辑</a> | <a href="model/selectModelById/${model.id}">查看详情</a></td>
    </tr>
</c:forEach>
